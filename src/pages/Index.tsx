  ...
  return (
    <div className="min-h-screen flex justify-center items-center overflow-hidden" style={{ background: '#1e3a6e', fontFamily: "Circular, Arial, sans-serif" }}>
      ...
      <div className="text-center p-8 w-full">
        ...
        {/* Title */}
        <div className="nh-title">NEXUSHUB</div>

        {/* Motto */}
        <div className="nh-subtitle">O N E &nbsp; H U B . &nbsp; A L L &nbsp; D A T A . &nbsp; M A D E &nbsp; S I M P L E</div>

        {/* Progress Bar */}
        <div className="nh-loader-bar">
          <div className="nh-loader-progress"></div>
        </div>
      </div>
    </div>
  );
