  ...
  return <Card className="bg-blue-50/80 border-blue-200 mb-6">
      <CardHeader>
        ...
        <div className="flex gap-4 justify-center">
          <div className="flex-1 max-w-lg w-[500px] min-w-[500px]">
            <label className="block text-sm font-medium text-gray-700 mb-2 text-center">Team Name</label>
            <div className="flex items-center gap-2">
              <MultiSelectDropdown options={teamOptions} value={selectedTeams} onChange={setSelectedTeams} placeholder="All Teams" className="text-center h-10 min-h-[40px] max-h-[40px]" labelClassName="bg-white h-10 min-h-[40px] max-h-[40px] overflow-hidden resize-none" dropdownClassName="w-[750px]" />
          ...
          <div className="flex-1 max-w-lg w-[500px] min-w-[500px]">
            ...
            <div className="flex items-center gap-2">
              <MultiSelectDropdown options={athleteOptions} value={selectedAthletes} onChange={setSelectedAthletes} placeholder="All Athletes" className="text-center h-10 min-h-[40px] max-h-[40px]" labelClassName="bg-white h-10 min-h-[40px] max-h-[40px] overflow-hidden resize-none" dropdownClassName="w-[750px]" />
