      ...
      {open && (
        <div className={cn(
          ...
          {options.map(opt => (
            ...
            >
              <span className={cn(
                "inline-flex h-4 w-4 items-center justify-center border border-gray-400 rounded mr-2",
                value.includes(opt.value) ? "bg-blue-500 text-white border-blue-500" : "bg-white"
              )}>
